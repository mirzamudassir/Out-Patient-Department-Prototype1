<?php
require_once('core/modal/Auth/configurations.inc.php');
?>
<html>
<head>
	<meta charset='UTF-8'>
...
<?php
$error= $_GET['error'];
$errorTitle= ltrim($error, "ERR_ACCESS_DENIED");
?>
  <div class="layout">
		<div class="title"><?php echo $error ?></div>
		<div class="text icon_500">Something went wrong. Report the administrator with the Error ID.</div>
		<div class="buttons">
        <a href="<?php echo $appBaseURL ?>" class="link_404">Go to Home</a>
		</div>
  </div>
</body>
</html>
