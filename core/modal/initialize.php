...
require_once(APP_ROOT . "/modal/Auth/validate.php");
require_once(APP_ROOT . "/controller/getController.php");
require_once(APP_ROOT . "/controller/postController.php");
require_once(APP_ROOT . "/controller/libs/generalFunctions.inc.php");
...
header("Location: $sandboxURL?error=DEVICE_NOT_SUPPORTED");  */ 
?>
