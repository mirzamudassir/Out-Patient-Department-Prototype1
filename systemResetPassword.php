            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                        <form class="md-float-material" id="resetPassword" name="resetPassword" method="POST" action="#" data-url="resetPassword">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-25 text-left">
                                    ...
                                    <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                        <a href="systemSignIn" class="text-right f-w-600 text-inverse"> Back to Sign In</a>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="resetPassword" id="resetPassword" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Submit</button>
                                    </div>
                                    <div class="col-md-12">
